export function createFooter(urlBooks,urlContact, footer){
    ...
    divGeneral.classList.add("max-width");
    ...
    const modalFooter=document.querySelector(".footer__modal");
    const btnModalFooter=document.querySelector(".footer__modal-btn");
    btnFooter.addEventListener("click",()=>{
        modalFooter.classList.remove("d-none");
        modalFooter.classList.add("d-modal")
    })
    btnModalFooter.addEventListener("click", ()=> {
            modalFooter.classList.add("d-none");
            modalFooter.classList.remove("d-modal");})
}

function getTerminesYConditions(container){
    container.innerHTML=`
        <div class="footer__modal-content">
        <h2 class="footer__modal-title c_Brown subtitle">Aviso de Privacidad y Uso de Cookies</h2>
